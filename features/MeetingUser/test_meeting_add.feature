Feature: Создать видеовстречу
  ...
  Scenario Outline: Создать видеовстречу
    ...
    When method: POST
    And get: response.json()[meetin_id]
  ...
  Examples:
    ...
    | doctor  | 200             | Namemeet     |                  | get_current_time_iso+1 | get_current_time_iso+2 | doctor_id  | Не указано описание встречи                          |
    ...
    | admin   | 403             | Namemeet     | Descriptionmeet  | get_current_time_iso+1 | get_current_time_iso+2 | doctor_id  | Не валидный токен                                    |
    | invalid | 401             | Namemeet     | Descriptionmeet  | get_current_time_iso+1 | get_current_time_iso+2 | doctor_id  | Не валидный токен                                    |
